...
import { Archive, BrainCircuit, Boxes, CheckCircle2, Fingerprint, GitBranch, PlugZap, Route, Scale, ShieldCheck, Sparkles, UsersRound } from 'lucide-react';
import './styles.css';
...
function LegalPage({ type }) {
  ...
  return (
    <main>
      <nav className="nav">
        <a className="brand" href="/"><span>AI</span> Archivista</a>
        <div className="navlinks">
          <a href="/">Home</a>
          <a href="/privacy">Privacy</a>
          <a href="/terms">Terms</a>
