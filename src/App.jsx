...
function PrivacyContent() {
  return (
    <div className="legal-card">
      ...
      <section><h2>Credentials and website analytics</h2><p>App settings are stored in your own deployment configuration. Protect the deployment with authentication and transport security. The main landing page uses self-hosted Umami for page views and coarse interactions such as navigation, installation links, section views, and standard campaign labels. Tracking stays off when Global Privacy Control or Do Not Track is enabled. Arbitrary query parameters, free-form input, cookies, local storage, persistent visitor identifiers, fingerprinting, newsletter forms, and advertising pixels are not collected.</p></section>
    </div>
  );
}
